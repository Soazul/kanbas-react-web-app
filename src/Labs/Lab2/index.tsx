...
export default function Lab2() {
    return (
      <div className="container">
        ...
        Althought it's very convenient it is considered bad practice and you 
        ...
        <div id="wd-css-document-structure">
          <div className="wd-selector-1">
            ...
            <p className="wd-selector-3">
              This paragraph's red background is referenced as <br/> .selector-2 .selector-3 <br/>
              meaning the descendant of some ancestor.<br/>
              <span className="wd-selector-4">
                Whereas this span is a direct child of its parent 
              </span><br/>
              You can combine these relationship to create specific styles depending on document structure.
            </p>
            </div>
          </div>
        </div>
