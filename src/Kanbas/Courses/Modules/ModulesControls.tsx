    ...
    return (
        <div id="wd-modules-controls" className="text-nowrap">
            ...
            <div className="dropdown d-inline me-1 float-end">
                ...
                <button id="wd-collapse-all" className="btn btn-lg btn-secondary me-1 float-start">Collapse All</button>
                <button id="wd-view-progress" className="btn btn-lg btn-secondary me-1 float-start">View Progress</button>
